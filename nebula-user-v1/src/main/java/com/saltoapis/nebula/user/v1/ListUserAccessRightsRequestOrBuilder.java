...
public interface ListUserAccessRightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:salto.nebula.user.v1.ListUserAccessRightsRequest)
