...
public  final class ListUsersRequest extends
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.saltoapis.nebula.user.v1.ListUsersRequest, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.saltoapis.nebula.user.v1.ListUsersRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.saltoapis.nebula.user.v1.ListUsersRequest> parser = PARSER;
        if (parser == null) {
          synchronized (com.saltoapis.nebula.user.v1.ListUsersRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.saltoapis.nebula.user.v1.ListUsersRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
