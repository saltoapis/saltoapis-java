...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              while (input.getBytesUntilLimit() > 0) {
                supportedTechnologies_.addInt(input.readEnum());
              }
    ...
    private com.google.protobuf.Internal.IntList supportedTechnologies_ = emptyIntList();
    private void ensureSupportedTechnologiesIsMutable() {
      if (!supportedTechnologies_.isModifiable()) {
