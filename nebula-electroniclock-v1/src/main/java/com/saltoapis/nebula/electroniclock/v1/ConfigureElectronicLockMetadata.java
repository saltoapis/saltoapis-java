...
public  final class ConfigureElectronicLockMetadata extends
    com.google.protobuf.GeneratedMessageLite<
        ConfigureElectronicLockMetadata, ConfigureElectronicLockMetadata.Builder> implements
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.saltoapis.nebula.electroniclock.v1.ConfigureElectronicLockMetadata, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.saltoapis.nebula.electroniclock.v1.ConfigureElectronicLockMetadata();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.saltoapis.nebula.electroniclock.v1.ConfigureElectronicLockMetadata> parser = PARSER;
        if (parser == null) {
          synchronized (com.saltoapis.nebula.electroniclock.v1.ConfigureElectronicLockMetadata.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.saltoapis.nebula.electroniclock.v1.ConfigureElectronicLockMetadata>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    ConfigureElectronicLockMetadata defaultInstance = new ConfigureElectronicLockMetadata();
    // New instances are implicitly immutable so no need to make
    // immutable.
    DEFAULT_INSTANCE = defaultInstance;
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      ConfigureElectronicLockMetadata.class, defaultInstance);
  }
  ...
  private static volatile com.google.protobuf.Parser<ConfigureElectronicLockMetadata> PARSER;
