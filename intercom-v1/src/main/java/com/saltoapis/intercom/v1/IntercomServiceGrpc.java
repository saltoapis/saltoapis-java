...
public final class IntercomServiceGrpc {
  ...
  public static final String SERVICE_NAME = "salto.intercom.v1.IntercomService";
   ...
   * </pre>
   */
  public static abstract class IntercomServiceImplBase implements io.grpc.BindableService {
   ...
   * </pre>
   */
  public static final class IntercomServiceStub extends io.grpc.stub.AbstractAsyncStub<IntercomServiceStub> {
   ...
   * </pre>
   */
  public static final class IntercomServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<IntercomServiceBlockingStub> {
   ...
   * </pre>
   */
  public static final class IntercomServiceFutureStub extends io.grpc.stub.AbstractFutureStub<IntercomServiceFutureStub> {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    private final IntercomServiceImplBase serviceImpl;
    private final int methodId;

    MethodHandlers(IntercomServiceImplBase serviceImpl, int methodId) {
