...
private static final long serialVersionUID = 0L;
    ...
    private int computeSerializedSize_0() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serialNumber_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, serialNumber_);
          ...
          {
            final int count = firmwares_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(firmwares_.get(i));
            }
            size += 1 * count;
          }
      return size;
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetManufactureDateFieldBuilder();
          internalGetFirmwaresFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
            ...
            if (firmwaresBuilder_.isEmpty()) {
              ...
              firmwaresBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetFirmwaresFieldBuilder() : null;
            } else {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                input.readMessage(
                    internalGetManufactureDateFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 18
      ...
      public com.saltoapis.type.Date.Builder getManufactureDateBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetManufactureDateFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Date manufactured
      ...
      public com.saltoapis.nebula.type.DeviceMetadata.CircuitBoard.Firmware.Builder getFirmwaresBuilder(
          int index) {
        return internalGetFirmwaresFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * Firmwares present in this circuit board.
      ...
      public com.saltoapis.nebula.type.DeviceMetadata.CircuitBoard.Firmware.Builder addFirmwaresBuilder() {
        return internalGetFirmwaresFieldBuilder().addBuilder(
      ...
      public java.util.List<com.saltoapis.nebula.type.DeviceMetadata.CircuitBoard.Firmware.Builder> 
        ...
        return internalGetFirmwaresFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
  ...
  private int computeSerializedSize_0() {
    int size = 0;
        ...
        {
          final int count = circuitBoards_.size();
          for (int i = 0; i < count; i++) {
            size += com.google.protobuf.CodedOutputStream
              .computeMessageSizeNoTag(circuitBoards_.get(i));
          }
          size += 1 * count;
        }
    return size;
  ...
  public static final class Builder extends
        ...
        if (!other.circuitBoards_.isEmpty()) {
          if (circuitBoardsBuilder_.isEmpty()) {
            ...
            circuitBoardsBuilder_ = 
              com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                 internalGetCircuitBoardsFieldBuilder() : null;
          } else {
    ...
    public com.saltoapis.nebula.type.DeviceMetadata.CircuitBoard.Builder getCircuitBoardsBuilder(
        int index) {
      return internalGetCircuitBoardsFieldBuilder().getBuilder(index);
    }
    /**
     * <pre>
     * Circuit boards present in this device.
    ...
    public com.saltoapis.nebula.type.DeviceMetadata.CircuitBoard.Builder addCircuitBoardsBuilder() {
      return internalGetCircuitBoardsFieldBuilder().addBuilder(
    ...
    public java.util.List<com.saltoapis.nebula.type.DeviceMetadata.CircuitBoard.Builder> 
      ...
      return internalGetCircuitBoardsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        ...
        internalGetCircuitBoardsFieldBuilder() {
      if (circuitBoardsBuilder_ == null) {
